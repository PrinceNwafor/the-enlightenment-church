/* ==========================================================================
   THE ENLIGHTENMENT CHURCH — MAIN JAVASCRIPT
   ========================================================================== */
...
(function () {
  ...
  /* --------------------------------------------------------------------------
     4. PRAYER REQUEST — Character counter
     -------------------------------------------------------------------------- */
  ...
  handleFormSubmit('prayer-form', "Your prayer request has been received. We're believing with you.");
  handleFormSubmit('visit-form', "Thank you! We'll reach out before Sunday to welcome you.");
  handleFormSubmit('newsletter-form', "You're subscribed! Welcome to the TEC family.");
  ...
  function showToast(message, type = 'success') {
    ...
    Object.assign(toast.style, {
      ...
      background: type === 'success' ? '#D4A017' : '#E07020',
      color: 'black',
      padding: '14px 24px', borderRadius: '40px',
      fontFamily: 'Inter, sans-serif', fontSize: '14px', fontWeight: '600',
      display: 'flex', alignItems: 'center', gap: '8px',
      boxShadow: '0 8px 32px rgba(212,160,23,0.35)',
      zIndex: '9999', transition: 'opacity 0.3s ease, transform 0.3s ease',
  ...
  function openVideoModal(videoId, platform = 'youtube') {
    ...
    Object.assign(backdrop.style, { position:'absolute', inset:'0', background:'rgba(0,0,0,0.92)', backdropFilter:'blur(8px)' });
    ...
    Object.assign(frame.style, { position:'relative', paddingBottom:'56.25%', borderRadius:'16px', overflow:'hidden', boxShadow:'0 24px 80px rgba(0,0,0,0.6)' });
  ...
  /* --------------------------------------------------------------------------
     ...
     -------------------------------------------------------------------------- */
  document.querySelectorAll('.help-suboption').forEach(opt => {
    opt.addEventListener('click', () => {
      document.querySelectorAll('.help-suboption').forEach(o => { o.style.borderColor = ''; o.style.background = ''; });
